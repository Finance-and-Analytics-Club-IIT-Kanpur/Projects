...
call_df["time_to_expiry"] = (call_df["time_to_expiry"]*365).astype(int)
call_df["sigma_20"] = (call_df["sigma_20"]*100).astype(int)
call_df["strike_price"] = (call_df["strike_price"]).astype(int)
call_df["close_option"] = (call_df["close_option"]).astype(int)
call_df["close_spot"] = (call_df["close_spot"]).astype(int)
